        ...
        <div className="bg-gray-200 mt-16">
            <div className="mx-auto max-w-7xl">
                ...
                <div className="flex w-full justify-center py-2 text-gray-500 pb-8">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={logosize} height={logosize} viewBox="0 0 50 50" fill="currentcolor">
                    ...
                    <Link href={'/'} className="px-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.0" stroke="currentColor" data-slot="icon" width={logosize} height={logosize}>
