    ...
    return(
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <ul className=" leading-relaxed text-gray-500 xl:text-lg ml-4 mt-4">
                ...
                <li className="py-2"><span className="font-bold">Comfort</span>: Cotton's softness and natural drape provide ergonomic comfort, reducing physiological stress. <br /><span className="italic">- Journal of Applied Physiology</span></li>
